<template>
    <div class="index">
        <navbar v-if="this.$session.has('TIENDA')"></navbar>
...
<style lang="scss">
    body {
        ...
        background-image: url("/images/AsrielGHD.png");
    ...
    .formLogin {
        width: 40%;
        height: 26em;
        font-family: "londrina-shadow","comic sans ms",sans-serif;
        font-size: 20px;
        color: white;
    ...
    .tgSQL {
        ...
        align-items: center;
        color: white;
        background-color: rgba(#231d1d,.75);
        ...
        div {
            ...
            box-sizing: border-box;
            border-radius: 20px;
            background-color: rgba( #2339bf,.75);
            overflow-y: scroll;
            overflow-x: hidden;
            padding: 3px;
