<?php
	...
	$datosTiendaYFactura=$datosFactura->datosFacturaYTienda();

	$fechasFactura=$datosFactura->datosFechaFactura();

	$datosProvEmpresa=$datosFactura->datosProveedorEmpresa();

	$imagen=$datosFactura->rutaImagen()['ImagenProducto'];
